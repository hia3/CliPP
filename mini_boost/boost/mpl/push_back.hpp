...
// $Source: /cvsroot-fuse/clipp/clipp/mini_boost/boost/mpl/push_back.hpp,v $
// $Date: 2005/02/20 15:34:32 $
// $Revision: 1.3 $
        ...
        ::template apply< Sequence,T >
{
    ...
    typedef push_back_impl< typename sequence_tag<Sequence>::type >
