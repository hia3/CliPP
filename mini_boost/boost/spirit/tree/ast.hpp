    ...
    public common_tree_tree_policy<MatchPolicyT, NodeFactoryT>
{
    ...
    template<typename MatchA,typename MatchB>
    static void concat(MatchA& a, MatchB const& b)
    {
    ...
    template <typename Iterator1T, typename Iterator2T,typename MatchT>
