...
struct static_with_arguments : public member_base<DerivedT>
{
    ...
    {
        static_assert(1 /*arg0*/ + sizeof...(Args) == arity, "");
...
private:
    ...
    {
        return get_doc_args(std::make_index_sequence<arity>{});
    }
    template<std::size_t... index>
    static auto get_doc_args(std::index_sequence<index...>)
    {
        return std::tuple<doc_arg<Signature, index>...>();
    }
